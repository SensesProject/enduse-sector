    ...
    <svg :width="innerWidth" :height="innerHeight - margin.bottom" :transform="`translate(${margin.left}, 0)`">
      ...
      <g v-for="(arc, a) in arcs" :key="`${a}-arc`">
        ...
        :y2="arc.yPos"
         ...
         :class="[arc.klass, {
           invisible: arc.klass[1] !== currentSector,
           selected: currentSelection === a,
           no_baseline: comparison === 'relative' & arc.klass[1] === currentSector
           }]"
         :r="arc.baseline"
         :cx="arc.year"
         :cy="arc.yPos"
        ...
        <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            <g id="Group-14" transform="translate(450, 20)">
                <g id="Residential and Commercial">
                    <circle
                    :class="{invisible: currentSector !== 'Residential and Commercial'}"
                    @mouseover="currentSector = 'Residential and Commercial'"
                    r="10"
                    cx="10"
                    cy="15"
                    id="Path-Copy-16"
                    ...
                    fill="#D8D8E4"
                    fill-rule="nonzero"/>
                    <text id="Residential and Commercial" fill="#000000">
                        <tspan x="29" y="20.374759">Residential and Commercial</tspan>
                    </text>
                ...
                <g id="Transportation" transform="translate(97, 0)">
                    <circle
                    :class="{invisible: currentSector !== 'Transportation'}"
                    @mouseover="currentSector = 'Transportation'"
                    r="10"
                    cx="10"
                    cy="15"
                    id="Path-Copy-16"
                    ...
                    fill="#ED96AB"
                    fill-rule="nonzero"/>
                    <text id="Transportation" fill="#000000">
                        <tspan x="33" y="20.374759">Transportation</tspan>
                    </text>
                    <g v-if="comparison === 'relative'">
                      <circle
                      class="no_baseline"
                ...
                <g id="Industry" transform="translate(195, 0)">
                    <circle
                    :class="{invisible: currentSector !== 'Industry'}"
                    @mouseover="currentSector = 'Industry'"
                    r="10"
                    cx="10"
                    cy="15"
                    id="Path-Copy-16"
                    ...
                    fill="#4E40B2"
                    fill-rule="nonzero"/>
                    <text id="Industry-(all)" fill="#000000">
                        <tspan x="33" y="20.374759">Industry (all)</tspan>
                    </text>
                    <g v-if="comparison === 'relative'">
                      <circle
                      class="no_baseline"
